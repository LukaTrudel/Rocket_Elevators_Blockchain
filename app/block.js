...
var contractTokenAddress = "0x3b8F02Aa259f1c55fC2afaFF9cC3695074Ff80EB";
...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    document.getElementById("mintRocketButton").addEventListener("click", function () {
        ConnectToSmartContractRocketToken();
    });
    document.getElementById("approveButton").addEventListener("click", function () {
        ConnectToRocketToken();
    });
});
...
function ConnectToSmartContractRocketToken() {
    var contractAddress;
    var web3 = new Web3(window.ethereum);
    web3.eth.net.getNetworkType().then(function (network) {
        if (network == "rinkeby") {
...
function ConnectToRocketToken() {
    ...
    web3.eth.net.getNetworkType().then(function () {
        ...
        contract.methods.approve(contractAddressEthereumRinkeby, "10000000000000000").send({ from: account });
    });
}
